...
<div class="mt-4 d-flex flex-wrap justify-content-between">
        {{-- tickt by status --}}
        <div class="card mb-3 shadow" style="max-width: 500px; flex-basis: 100%; flex-grow: 1;">
            <div class="row g-0">
        ...
        {{-- most issue --}}
        <div class="card mb-2 shadow" style="flex-basis: calc(50% - 10px); flex-grow: 0; padding: 5px;">
            <div class="card text-center shadow" style="height: 148px;">
                <div class="card-body">
                    <h5 class="card-title" style="color: rgba(248, 198, 0, 0.875)">MOST REPORTED ISSUE</h5>
            ...
            <div class="card text-center shadow" style="height: 150px; margin-top: 7px;">
                <div class="card-body">
                    <h5 class="card-title" style="color: rgb(255, 132, 0)"># OF VIEWS</h5>
        ...
        <div class="card mb-2 shadow" style="flex-basis: calc(50% - 10px); flex-grow: 0; padding: 5px;">
            <div class="card text-center shadow" style="height: 150px;">
                <div class="card-body">
                    <h5 class="card-title" style="color: rgba(248, 198, 0, 0.875)">MOST VIEWED KB</h5>
