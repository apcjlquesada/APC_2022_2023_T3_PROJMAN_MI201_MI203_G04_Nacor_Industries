 ...
 <div
     style="background-color: #22246C;color: black;position: fixed;top: 0;left: 0;right: 0;height: 80px;z-index: 10;border-bottom:#eda302a5 solid 5px;">
     ...
     <div class="" style="position: absolute; left: 5%; top: 15%;">
         <h5 class="" style="font-size: auto; color: white;">
             <strong>{{ $user->u_name }}</strong></h6>
             <p style="color: white;">{{ $user->u_divRole }}</p>
     </div>
     ...
     <nav>
         <ul class="sideB">
             ...
             <li class="sbarIcon">
                 ...
                 <a href="{{ url('staffViewAllTickets') }}" class="aa">
