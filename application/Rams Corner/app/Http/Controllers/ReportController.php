...
class ReportController extends Controller
{
    public function generateReport()
    {
        ...
        if($user->u_role == "Admin"){
            return view('admin_reports', ['monthly'=>$monthly,
            'admin'=>$user_info,
            'years'=>$years,
            'allStaff'=>$allStaff,
            ...
            return view('staff_reports', ['monthly'=>$monthly,
            'staff'=>$user_info,
            'years'=>$years,
            'allStaff'=>$allStaff,
            'reportData'=>$reportData,
    ...
    public function generateReportbyFilter($reportdata, $request)
    {
        ...
        if($user->u_role == "Admin"){
            return view('admin_reports', ['admin'=>$user_info,
            'years'=>$years,
            'allStaff'=>$allStaff,
            'reportData'=>$reportdata,
            'display'=>'block',
            ...
            return view('staff_reports', ['staff'=>$user_info,
            'years'=>$years,
            'allStaff'=>$allStaff,
            'reportData'=>$reportdata,
            'display'=>'block',
