                    ...
                    <tbody>
                        @foreach ($tickets as $ticket)
                            <tr onclick="openDiv({{ $ticket->t_ID }})">
                                ...
                                @php
                                    $diff = Carbon\Carbon::today()->diffInMinutes($ticket->t_due);
                                @endphp
                                <td>
                                    @if ($diff >= 1)
                                        @if (
                                            $ticket->t_status != 'Resolved' ||
                                                ...
                                                $ticket->t_status != 'Closed' ||
                                                $ticket->t_status != 'Rejected')
                                            <p style="color: red; font-weight: 1000"> 1 </p>
                                        @endif
                                    @endif
