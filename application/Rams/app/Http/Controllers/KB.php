...

{
    public function admin_KB()
    {
        ...
        return view('admin_KB',['kb_info' => $kb_info,
                                'admin'=>$user_info,
    ...
    public function user_KB()
    {
        ...
        $kb_info = k_b_s::where('kb_approved', 1)
                        ->where('kb_view', 1)
                        ->get();
        return view('user_KB',['kb_info' => $kb_info, 'client'=>$user_info]);
    }
    ...
    public function staff_KB()
    {
        ...
        $user_info = User::where('u_ID', $staff->u_ID)->get();
        $kb_info = k_b_s::where('kb_approved', 1)->get();
        return view('staff_KB',['kb_info' => $kb_info, 'staff'=>$user_info]);
    }
    ...
    public function adminkbView($id)
    {
        ...
        return view('adminkbView',['kb_info' => $kb_info, 'admin'=>$user_info]);
    }
    ...
    public function staffkbView($id)
    {
        ...
        return view('staffkbView',['kb_info' => $kb_info, 'staff'=>$user_info]);
    }
    ...
    public function userkbView($id)
    {
        ...
        return view('userkbView',['kb_info' => $kb_info, 'client'=>$user_info]);
    }
