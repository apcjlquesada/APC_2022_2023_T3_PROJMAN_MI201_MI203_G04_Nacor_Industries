...
class StaffController extends Controller
{
    ...
    public function staffViewAllTickets(){
        ...
        $assignedTickets = Ticket::all();


        $currentDateTime = now();
            return view('staff_view_ticket',["tickets"=>$assignedTickets, "users"=>$allUsers, "staff"=>$user_info, 'allStaff'=>$allStaff, 'curDatetime'=>$currentDateTime]);
