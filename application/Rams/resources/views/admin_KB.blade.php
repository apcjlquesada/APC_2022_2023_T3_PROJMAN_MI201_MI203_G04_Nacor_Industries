...
@foreach ($admin as $user)
    ...
    <div class=""
        ...
        <div style="position: relative;">
            ...
            <div class="container text-center">
                <div class="row align-items-start">
                    <div class="col notification m-2 bg-warning" id="showDiv1"
                        style="position: relative;display: inline-block; padding: 1%; color: #000000; font-size: 18px; border-radius: 4px; cursor: pointer;">
                        <span class="text" style="margin-right: 10px">Unapproved</span>
                        <span class="badge"
                            style=" position: absolute; top: 5px; right: 5px;display: flex; justify-content: center;align-items: center; width: 25px; height: 25px; background-color: #fff; color: #f44336; border-radius: 50%; font-size: 14px; box-shadow: 0 0 0 1px #f44336;">{{ $unapp_count }}</span>
                    </div>

                    <div class="col notification m-2 bg-info" id="showDiv2"
                        style="position: relative;display: inline-block; padding: 1%; color: #000000; font-size: 18px; border-radius: 4px; cursor: pointer;">
                        <span class="text" style="margin-right: 10px">Approved</span>
                        <span class="badge"
                            style=" position: absolute; top: 5px; right: 5px;display: flex; justify-content: center;align-items: center; width: 25px; height: 25px; background-color: #fff; color: #f44336; border-radius: 50%; font-size: 14px; box-shadow: 0 0 0 1px #f44336;">{{ $app_count }}</span>
                    </div>
                </div>
            </div>

            <form id="search-form">
                <input id="search-input" type="search" name="searchKB" placeholder="Search Knowlede Base"
            ...
            <ul class="nav nav-pills m-3 fs-4" id="pills-tab" role="tablist" style="justify-content: center; ">
                ...
                <li class="nav-item" role="presentation">
                    <button onclick="showElement('Infrastructure')" class="nav-link" id="Infrastructure"
                        ...
                        aria-controls="pills-profile" aria-selected="false">Infrastracture</button>
                </li>
                <li class="nav-item" role="presentation">
                        ...
                        <a href="/adminkbView/{{ $kb_info->kb_ID }}" class="card content {{ $kb_info->kb_category }}"
                            ...
                            <div class="card-body">
                                <blockquote class="blockquote mb-0">
                                    <p>{{ \Illuminate\Support\Str::limit($kb_info->kb_content, 30) }}</p>
        ...
        <div style="position: fixed; bottom: 0%; right: 5%; bottom: 5%;">

            <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#createModal"
                data-bs-whatever=""><i class="bi bi-plus-circle-fill"></i> Create KB</button>
        </div>
