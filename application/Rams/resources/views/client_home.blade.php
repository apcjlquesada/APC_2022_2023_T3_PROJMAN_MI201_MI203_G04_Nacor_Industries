    ...
    ">
        ...
        <main>
            <div class="welcome-message mb-4">
                ...
                <p>Here, you can find answers to some frequently asked questions and check the status of your ticket.
                </p>
            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <div class="row">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p>3. <strong>Urgency</strong> – You are entitled to select Urgency
                                        <strong>(Critical, Urgent, Normal)</strong> in your tickets depending on how
                                        severe the issues, inquiry needs urgent solution (e.g., (1) Critical
                                        problems/issues that can greatly affect an individual or large amount of
                                        people
                                        “the classroom has no internet connection” therefore, students will have to
                                        be
                                        relocated to another classroom with internet to continue the class (2)
                                        Urgent
                                        problems/issues that can affect a student personally “LinkedIn account needs
                                        re-licensing activation to use for academic purposes such as completion for
                                        academic deadlines” (3) Normal problems/issues relating to “a broken mouse
                                        on a
                                        specific PC in the computer lab”.
                                    </p>
                                    <p>4. <strong>Impact</strong> – you are entitled to decide on what you think how
                                        critical your problem/issues with regards to the ticket you create. This
                                        dictates how much a problem can potentially damage or lose caused by the
                                        problem
                                        you encountered.</p>
                                    <p>5. <strong>Title</strong> – this is where you will put the short description
                                        regarding your ticket.</p>
                                    <p>6. <strong>Ticket Description</strong> – you can give a long description of
                                        what
                                        the ticket is about and all the details you need to include, to further
                                        elaborate the ticket.</p>
                                    <p>7. <strong>Upload file</strong> – you can attach an image or any file that
                                        will
                    ...
                    <div class="modal fade" id="ticketsModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="text-center">
                                        <img src="{{ url('images/view.png') }}" alt="your-image-alt"
                                            class="img-fluid">
                                    </div>
                                    <p>1. <strong>Home</strong> – this will lead to the home page of Ram’s Corner:
                                        IT
                                        ticketing system.</p>
                                    <p>2. <strong>My tickets</strong> – if you want to see your ticket history sent,
                                        you
                                        will click this button and it will display all the tickets that you sent.
                                    </p>
                                    <p>3. <strong>Knowledge base</strong> – This library contains the steps and
                                        guides
                                    ...
                                    <p>4. <strong>Create Ticket</strong> – you can create and send a ticket to ITRO
                                        office by clicking the create ticket button and fill out necessary details
                                        needed to create a ticket (refer to page 1 for more information regarding
                                        creation of ticket).</p>
                                    <p>5. <strong>Category</strong> – this button allows you to see if the ticket
                                        category falls under the infrastructure or software category.</p>
                                    <p>6. <strong>Staff Assigned</strong> – This filter button allows you to filter
                                        and
                                        check on whose ITRO personnel have been assigned to assist you on your
                                        ticket.
                                    </p>
                                    <p>7. <strong>Status</strong> – if you were to click this button, this allows
                                        you to
                                        filter the ticket based on its status (New, Opened, Pending, Ongoing,
                                        Resolved,
                                        Closed, Reopened, Rejected, Cancelled). </p>
                                    <p>8. <strong>Priority</strong> – This filter button allows you to filter your
                                        ticket sent based on its priorities (P1, P2, P3) which is determined by the
                                        ticket Impact and Urgency. </p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Close</button>
                ...
                <div class="col-md-4">
                    <div class="placeholder-div card" type="button" data-bs-toggle="modal"
                        data-bs-target="#kbModal" style="border-left: 10px solid #ffaa00 ">
                  ...
                  <img src="mytickets.png" alt="your-image-alt" class="img-fluid">
                                    ...
                                    <p>2. <strong>Opened</strong>- The ticket is now opened by the ITRO staff or
                                        admin
                                        for inspection.</p>
                                    <p>3. <strong>Resource Pending</strong>- The ticket is now being reviewed. The ITRO
                                        staff
                                        or
                                        admin is checking if the ticket is relatively part of their scope of work,
                                        which
                                        if so, shall be provided with corresponding solution.</p>
                                    ...
                                    <p>6. <strong>Closed</strong>- the ticket is closed by the ITRO Staff or admin
                                        after
