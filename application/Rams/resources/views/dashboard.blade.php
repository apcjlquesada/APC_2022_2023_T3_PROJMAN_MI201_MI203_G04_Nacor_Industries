...
<div class="overflow-auto"
    ...
    <div style="  display: flex; justify-content: space-between;">
        <div class="card text-center shadow" style="width: 10%; ">
            <div class="card-header" style="height:5px; background-color:blue">
            </div>
            <div class="card-body">
        ...
        <div class="card text-center shadow" style="width: 10%;">
            <div class="card-header" style="height:5px; background-color:#0033ffc3">
            </div>
            <div class="card-body">
        ...
        <div class="card text-center shadow" style="width: 10%;">
            <div class="card-header" style="height:5px; background-color:#0033ff81">
            </div>
            <div class="card-body">
        ...
        <div class="card text-center shadow" style="width: 10%;">
            <div class="card-header" style="height:5px; background-color:#15ff007e">
            </div>
            <div class="card-body">
        ...
        <div class="card text-center shadow" style="width: 10%;">
            <div class="card-header" style="height:5px; background-color:#15ff007c">
            </div>
            <div class="card-body">
        ...
        <div class="card text-center shadow" style="width: 10%;">
            <div class="card-header" style="height:5px; background-color:#00ff08">
            </div>
            <div class="card-body">
        ...
        <div class="card text-center shadow" style="width: 10%;">
            <div class="card-header" style="height:5px; background-color:#ff2f2f7f">
            </div>
            <div class="card-body">
        ...
        <div class="card text-center shadow" style="width: 10%;">
            <div class="card-header" style="height:5px; background-color:#ff0000bd">
            </div>
            <div class="card-body">
        ...
        <div class="card text-center shadow" style="width: 10%;">
            <div class="card-header" style="height:5px; background-color:#ff0000">
            </div>
            <div class="card-body">
                <h5 class="card-title" style="color: red">OVERDUE<br><br></h5>
                <h1 class="card-text" style="color: red"><b>{{ $all }}</b></h1>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <script type="text/javascript">
            ...
            function drawVisualization() {
                ...
                var options = {
                    ...
                    colors: ['orange', 'yellow', 'green', 'blue', 'red', 'cyan', 'violet', 'indigo'],
                    legend: {
                        position: 'right',
                        textStyle: {
                            color: 'black',
        ...
        <div class="mt-4" style="display: flex; justify-content: space-between;">
            ...
            <div class="card mb-2 shadow" style="width: 250px;padding:5px">
                <div class="card text-center shadow" style="height:150px">
                    <div class="card-body">
                        <h5 class="card-title" style="color: rgba(248, 198, 0, 0.875)">MOST VIEWED TICKET<br></h5>
                        <h1 class="card-text" style="color: rgba(248, 198, 0, 0.875)">
                            <b>#{{ $mostViewTix }}</b>
                        </h1>
                    </div>
                </div>
            ...
            <div class="card mb-2 shadow" style="width: 250px;padding:5px">
                <div class="card text-center shadow" style="height:150px">
                    <div class="card-body">
                        <h5 class="card-title" style="color: rgba(248, 198, 0, 0.875)">MOST VIEWED KB<br></h5>
                        <h1 class="card-text" style="color: rgba(248, 198, 0, 0.875)">
                            <b>#{{ $mostViewKB }}</b>
                        </h1>
                    </div>
        ...
        <div class="card mb-2 shadow" style="max-width: 397px;margin-top: -21%;margin-left:74%">
            <div id="donut-chart"></div>
        </div>

        <div class="position-absolute bottom-4 end-0 me-4 mb-3" style="margin-top:-18%">
            <a href="{{ url('generateReport') }}" type="button" class="btn btn-primary btn-lg"
                title="View Full Reports">
                <i class="bi bi-clipboard-data-fill" style="font-size: 80px; "></i>
            </a>
        </div>
