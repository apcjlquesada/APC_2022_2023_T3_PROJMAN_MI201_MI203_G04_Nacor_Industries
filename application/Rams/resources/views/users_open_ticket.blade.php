            ...
            <div class="" style="border: 1px solid #ccc; border-radius: 5px; overflow: hidden;">
                <div class="email-header"
                    ...
                    <div class="sender" style="font-size: 18px;">
                        <span class="sender-name" style="font-weight: bold;">{{ $userinfo->u_name }}</span>
                    ...
                    <div class="subject" style=" font-size: 24px; margin-top: 10px;">
                        ...
                        <span class="sender-tID"
                            style="color: #000000; margin-left: 70%; font-size:30px; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
